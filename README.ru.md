...
- **API:** из 1254 публичных типов `System.Windows.Forms` + `System.Drawing.Common` 662 — полные,
  162 — частично, 430 — нет ([покрытие](docs/api/README.md)).
- **Поведение:** 401/401 тестов; раскладка, порядок событий, метрики текста и то, что пишет дизайнер,
