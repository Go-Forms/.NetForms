...
- **API:** из 1254 публичных типов `System.Windows.Forms` + `System.Drawing.Common` 652 — полные,
  160 — частично, 442 — нет ([покрытие](docs/api/README.md)).
- **Поведение:** 390/390 тестов; раскладка, порядок событий, метрики текста и то, что пишет дизайнер,
