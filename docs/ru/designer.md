...
- Редактора темы.
- Контролов из сторонних библиотек и своих контролов проекта: на холсте они пока заглушки с именем типа.
  Как это будет устроено — [designer-control-libraries.md](../designer-control-libraries.md).
