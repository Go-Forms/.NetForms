...
> Прочитай `CLAUDE.md`, в `docs/PLAN.md` — раздел «С чего начать следующую сессию» и решения 127–143. Работай сразу
> в `main` (разрешено заказчиком). Пункт 1 сделан и выпущен в `0.1.0-preview.2` (решения 139–143); начни с проверки,
> что выпуск дошёл (пакеты на nuget.org, GitHub Release `v0.1.0-preview.2`, расширение `0.1.1`), затем пункт 2.
...
> записывай в журнал (со 144).

**Состояние на 2026-09-24.** Выпускается `0.1.0-preview.2` (решение 143): привязка данных WinForms, правка в `DataGridView`,
