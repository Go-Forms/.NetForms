...
> Прочитай `CLAUDE.md`, в `docs/PLAN.md` — раздел «С чего начать следующую сессию» и решения 127–147. Сначала
...
> `designer: npm test`. Решения, которых нет в плане, записывай в журнал (со 148).
