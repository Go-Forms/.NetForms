...
> Прочитай `CLAUDE.md`, в `docs/PLAN.md` — раздел «С чего начать следующую сессию» и решения 127–148. Сначала
...
> `designer: npm test`. Решения, которых нет в плане, записывай в журнал (со 149).

**Состояние на 2026-09-25.** Выпущен `0.1.0-preview.4` (решение 148): строка для новых записей `DataGridView` —
