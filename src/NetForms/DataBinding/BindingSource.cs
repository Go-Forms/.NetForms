...
[Description("Encapsulates a data source for a form and provides navigation, filtering, sorting, and updating capabilities.")]
                             ...
                             ICurrencyManagerProvider
{
    ...
    [Category("Data")]
    [Description("Event raised when an exception thrown during data binding is handled internally by the CurrencyManager.")]
    ...
    public virtual string? Filter
    {
        ...
        [RequiresUnreferencedCode("The Type of the data source is not statically known. Binding to properties of an IBindingListView filter may require types that were trimmed.")]
        set
        {
            _filter = value;
